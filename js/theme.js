			...
			if(slider){
		        jQuery("#slidePriceDiv .slider").slider({
		            ...
		            slide: function(event, ui){
		                ...
		                $("#slidePriceDiv .ui-slider-handle span.max").text(ui.values[1]);
		            },
		            stop:function(event, ui){
		                $("#slidePriceDiv input.j-min").val(ui.values[0]);
				...
				jQuery("#slideYearDiv .slider").slider({
					...
					range: true,
					slide: function(event, ui){
						$("#slideYearDiv .ui-slider-handle span.min").text(ui.values[0]);
						$("#slideYearDiv .ui-slider-handle span.max").text(ui.values[1]);
					},
					stop:function(event, ui){
						$("#slideYearDiv input.j-min").val(ui.values[0]);
						$("#slideYearDiv input.j-max").val(ui.values[1]);
					}
				});
				$("#slideYearDiv .ui-slider-handle:first-of-type").append("<span class='min'>2008</span>");
				$("#slideYearDiv .ui-slider-handle:last-of-type").append("<span class='max'>2020</span>");
			}
		},
